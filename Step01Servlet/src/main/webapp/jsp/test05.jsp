...
String nickname = "짱구";
String gender = "woman"; // "man" or "woman" 이 DB에 저장 되어 있다고 가정
String job = "developer"; // stdunet, developer, etc
...
<body>
	<h1>어떤 정보를 수정하는 폼</h1>
	<p>최초 출력 할 때는 DB에 저장 된 정보를 이용해서 여러가지 form 요소들을 출력해준다.</p>
	
	<strong><%=true ? "감자" : "" %></strong>
	<form action="update.jsp" method="get">
		...
		<textarea name="comment" id="comment"rows="5"> <%=comment %>
		</textarea>
		</div>
		<fieldset>
