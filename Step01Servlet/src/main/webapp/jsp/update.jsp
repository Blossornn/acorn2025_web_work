...
// 취미 정보는 넘어오지 않을 수도 있고 혹은 1개에서 3개가 넘어 올 수도 있다.
String[] hobbys = request.getParameterValues("hobby"); //null일 가능성도 있음
...
// 다운로드 해서 lib 폴더에 넣은 gson-xxx.jar 파일에 포함된 클래스로 생성된 객체를 이용해
